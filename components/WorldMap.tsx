          ...
          <Geographies geography={geoUrl}>
            ...
            return filtered.map((geo: any) => {
                ...
                const isSelected = selectedPlace
                  ? (isIran && selectedPlace.country === 'Iran' && !selectedPlace.state && !selectedPlace.city) ||
                    (!isIran && countriesMatch(countryName, selectedPlace.country) && !selectedPlace.state && !selectedPlace.city)
                  : false;
                ...
                return (
                  <Geography
                    ...
                    style={{
                      default: { outline: 'none', cursor: hasImages || isIran ? 'pointer' : 'default' },
                      hover: {
